...
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emailsenderconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emailsenderconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emailsenderconfigs/finalizers,verbs=update
...
func (r *EmailSenderConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&mailv1alpha1.EmailSenderConfig{}).
		Complete(r)
}
