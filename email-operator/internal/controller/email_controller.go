...
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emails,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emails/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=mail.mailertest.com,resources=emails/finalizers,verbs=update
